...
use Nemundo\Bfs\Gemeinde\Data\Bezirk\BezirkDelete;
use Nemundo\Bfs\Gemeinde\Data\Bezirk\BezirkReader;
use Nemundo\Bfs\Gemeinde\Data\Gemeinde\Gemeinde;
use Nemundo\Bfs\Gemeinde\Data\Gemeinde\GemeindeDelete;
use Nemundo\Bfs\Gemeinde\Data\Kanton\Kanton;
use Nemundo\Bfs\Gemeinde\Data\Kanton\KantonDelete;
...
class GemeindeCleanScript extends AbstractConsoleScript
{

    protected function loadScript()
    {
        $this->scriptName = 'gemeinde-clean';
    }

    public function run()
    {

        (new KantonDelete())->delete();
        (new BezirkDelete())->delete();
        (new GemeindeDelete())->delete();
